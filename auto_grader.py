...
#                print "result file is " + resultfile
            ...
            if resultfile[len(resultfile)-5] == "1" :
                ...
                try:
                    run_command("./%s 512 assoc:4 fifo 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:8 fifo 8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:2 fifo 1 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 32 assoc:2 lru 4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 32 direct lru 4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
            ...
            if os.system(command)==0:
                ...
                if (resultfile[len(resultfile)-5] == "7"):
                    myscore = myscore + 7.5
                else:
                    myscore = myscore + 5
            else:
